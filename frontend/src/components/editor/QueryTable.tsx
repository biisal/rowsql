...
export function QueryTable({ data, error }: QueryTableProps) {
    ...
    if (!data.columns?.length) return <TableEmptyState message="Query executed successfully" variant="success" />;
...
const TableEmptyState = ({ message, variant = "default" }: TableEmptyStateProps) => (
