...
export const RowOrderForm = ({ cols , setUrlParams , initialValue }: RowOrderFormProps) => {
	const [selectedCol, setSelectedCol] = useState<string | null>((initialValue && initialValue.col) || (cols && cols.length > 0 ? cols[0].columnName : null));
	const [selectedOrder, setSelectedOrder] = useState<string | null>(initialValue && initialValue.order || "asc");
